...
if(isset($_SESSION['username'])){
	...
	$fetch_total_transactions = mysqli_fetch_assoc(mysqli_query($conn, "SELECT COUNT(*) AS total FROM payment"));
	$fetch_total_credit = mysqli_fetch_assoc(mysqli_query($conn, "SELECT COUNT(*) AS total FROM payment where transaction_type='credit'"));
	$fetch_total_debit = mysqli_fetch_assoc(mysqli_query($conn, "SELECT COUNT(*) AS total FROM payment where transaction_type='debit'"));
?>
...
<head>
    ...
    <title>NearPay Payment Service | Dashboard</title>
...
<body>
    <div class="header">
        <div class="side-nav">
            <a href="#" class="logo">Near Pay Service</a>
            <ul class="nav-links">
                <li>
